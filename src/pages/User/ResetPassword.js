...
function ResetPassword() {
    ...
    const handleResetPassword = async (event) => {
        ...
        try {
            const response = await fetch('https://dsrkzpzrzxqkarjw.tunnel-pt.elice.io/api/auth/check', {
                method: 'POST',
                headers: {
            ...
            if (checkResult.data === true) {
                ...
                await fetch('https://dsrkzpzrzxqkarjw.tunnel-pt.elice.io/api/auth/check/reset', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
